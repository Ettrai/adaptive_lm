...
def main(lm_opt):
    ...
    if(lm_opt.freeze_model):
        ...
        lm_opt.parameter_masks = cPickle.load(open("../data/r1.0/masks/window/parameters_" + file_suffix, "r"))
        lm_opt.freeze_masks = cPickle.load(open("../data/r1.0/masks/window/freeze_" + file_suffix , "r"))
